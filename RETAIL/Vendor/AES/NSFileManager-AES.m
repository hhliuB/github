...
-(BOOL)AESEncryptFile:(NSString *)inPath toFile:(NSString *)outPath usingPassphrase:(NSString *)pass keybits:(NSInteger)keybits error:(NSError *__autoreleasing *)error
{
...
-(BOOL)AESDecryptFile:(NSString *)inPath toFile:(NSString *)outPath usingPassphrase:(NSString *)pass keybits:(NSInteger)keybits error:(NSError *__autoreleasing *)error
{
	unsigned long rk[RKLENGTH(keybits)];
	unsigned char key[KEYLENGTH(keybits)];
	const char *password = [pass UTF8String];
